                    ...
                    <div class="container n-form2">
                        ...
                        <div class="form-group row m-0 pb-1">
                            ...
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
                                ...
                                <input type="text" id="basic-salary" class="form-control" oninput="calculateSalary()" value="<?= $basic_salary ?>" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row m-0 pb-1">
                            ...
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
                                <input name="house_rent" type="text" id="house-rent" class="form-control" value="<?= $house_rent ?>" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row m-0 pb-1">
                            ...
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
                                <input name="ta" type="text" id="convenience" class="form-control" value="<?= $ta ?>" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
                    <div class="form-group row m-0">
                        ...
                        <div class="col-sm-9 col-md-9 col-lg-9 col-xl-9 p-0">
                            <input name="gross_salary" type="text" id="gross-salary" class="form-control" value="<?= $gross_salary ?>" />
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
                    <div class="form-group row m-0">
                        ...
                        <div class="col-sm-9 col-md-9 col-lg-9 col-xl-9 p-0">
                            <input name="total_payable" type="text" id="total-payable" value="" readonly="" class="form-control" />
