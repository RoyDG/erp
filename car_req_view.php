...
$PBI_ID = find_a_field('user_activity_management','PBI_ID','user_id='.$u_id);
	...
	if(isset($_POST['confirmm'])){
		...
		clnt_prf="'.$_POST['clnt_prf'].'", clnt_org_name="'.$_POST['clnt_org_name'].'",land="'.$_POST['land'].'", pup="'.$_POST['pup'].'", dop="'.$_POST['dop'].'", emp_name="'.$_POST['emp_name'].'", mb_no="'.$_POST['mb_no'].'", v_s_t="'.$_POST['v_s_t'].'", nop="'.$_POST['nop'].'"
